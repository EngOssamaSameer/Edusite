...
if (
    ...
    $sup = $_POST['sub'];
    $msg = $_POST['msg'];
    $contact = $auth->contact($_SESSION["userId"],$sup,$msg);
    
    if ($contact) {
        // Profile update successful
        $errMsg = "sent successful!";
    } else {
...
if ($errMsg !== false) {
    echo '<div class="alert alert-' . ($contact ? 'success' : 'danger') . ' mt-3">' . $errMsg . '</div>';
}
...
?>
                    ...
                    <form  method="post" action="contact.php">
                            ...
                            <div class="form-group">
                                <textarea class="form-control border-top-0 border-right-0 border-left-0 p-0" rows="5" name="msg" placeholder="Message" required="required"></textarea>
                            </div>
                            <div>
